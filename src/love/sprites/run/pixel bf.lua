return graphics.newSprite(
	love.graphics.newImage(graphics.imagePath("run/BF")),
	...
	{
		["dead"] = {start = 38, stop = 43, speed = 24, offsetX = 0, offsetY = 0},
		["dead confirm"] = {start = 38, stop = 43, speed = 24, offsetX = 0, offsetY = 0},
		...
		["dies"] = {start = 22, stop = 36, speed = 24, offsetX = 0, offsetY = 0},
		["idle"] = {start = 1, stop = 5, speed = 24, offsetX = 0, offsetY = 0}
	},
	"idle",
	false
)
