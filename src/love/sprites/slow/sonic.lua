return graphics.newSprite(
	love.graphics.newImage(graphics.imagePath("slow/Sonic_EXE_Assets")),
	-- Automatically generated from Sonic_EXE_Assets.xml
	{
...

    {
        ...
        ["down"] = {start = 12, stop = 22, speed = 24, offsetX = 90, offsetY = -17},
        ["down alt"] = {start = 1, stop = 11, speed = 24, offsetX = 30, offsetY = -20},
        ["left"] = {start = 34, stop = 44, speed = 24, offsetX = 139, offsetY = -4},
        ["left alt"] = {start = 34, stop = 44, speed = 24, offsetX = 139, offsetY = -4},
        ["right"] = {start = 45, stop = 55, speed = 24, offsetX = -16, offsetY = 20},
        ["right alt"] = {start = 67, stop = 335, speed = 24, offsetX = -61, offsetY = 0},
        ["up"] = {start = 56, stop = 66, speed = 24, offsetX = -33, offsetY = 13},
        ["up alt"] = {start = 56, stop = 66, speed = 24, offsetX = -33, offsetY = 13}
    },
    "idle",
	false
)
